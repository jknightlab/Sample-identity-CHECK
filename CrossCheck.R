...
# low mapping rate sample removal                             
data$BIONIC_133_preop_rep = NULL
data = data[data$READGROUP !="BIONIC_133_preop_rep",]
...
# if no, replace the characters/factors as numerics NOTE: replace the "," to "" to avoid generating incorrected NA values
...
# generate matrix and plot by pheatmap
